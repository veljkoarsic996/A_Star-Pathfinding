...
public class PathfindingBlue : MonoBehaviour
{
    ...
    private void Start()
    {
        GridReference = GameObject.FindGameObjectWithTag("BlueGameManager").GetComponent<Grid>();
        StartPosition = transform;
        TargetPosition = GameObject.FindGameObjectWithTag("RedTower").transform;
